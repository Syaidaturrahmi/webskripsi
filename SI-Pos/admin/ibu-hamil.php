                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                  <?php
                                  $no = 1;
                                  $sql = mysqli_query($con, "SELECT *,YEAR(CURRENT_DATE) - YEAR(tgl_lahir) AS usia FROM ibu");
                                  ...
                                  ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit-ibu-hamil.php?kode=<?= $data['kode_ibu'] ?>" class="btn btn-warning"><i class="fa fa-pencil-square"></i>Ubah</a>
                                            <a href="del-ibu-hamil.php?kode=<?= $data['kode_ibu'] ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin?');"><i class="fa fa-trash-o"></i>Hapus</a>
                                        </td>
                                    </tr>
                                    <?php $no++;}?>
                                </tbody>
